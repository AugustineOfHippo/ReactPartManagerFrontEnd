...
export default function EditPartComponent() {
    ...
    const handleDelete = async(e) => {
      e.preventDefault();
        await axios.delete('http://18.139.225.131:4000/parts/delete/' + myPart._id)
            .then(async(res) => {
      ...
      const onSubmit = async(e) => {
        e.preventDefault();
        await axios.put('http://18.139.225.131:4000/parts/edit/' + myPart._id,myPart)
        .then(async(res) => {
    ...
    const getPartById = async() => {
      if(partid !== '') {
        await axios.get(`http://18.139.225.131:4000/parts/part/onePart/${partid}`)
        .then((res) => {
          setMyPart(res.data);
        })
        await axios.get(`http://18.139.225.131:4000/trucks/${truckid}`)
        .then((res) => {
                setMyTruck(res.data);
        })
      }
